...
from app.routers import projects, passages, collation, export, resolution, kgraph, transmission, controversy
...
app.include_router(controversy.router, tags=["controversy_analysis"])
